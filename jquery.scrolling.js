...
var Smooth = function () {
    function Smooth() {
        ...
        this.vs = this.vars.native ? null : new _virtualScroll2.default({
            ...
            mouseMultiplier: opt.vs && opt.vs.mouseMultiplier || 0.4, // 1
            touchMultiplier: opt.vs && opt.vs.touchMultiplier || 2,
            firefoxMultiplier: opt.vs && opt.vs.firefoxMultiplier || 60, // 30
