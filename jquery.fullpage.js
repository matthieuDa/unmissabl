...
(function($) {
    ...
    $.fn.fullpage = function(options) {
        ...
        for (var i = 0; i < $childrenCount; i ++) {
            ...
            if (i == 0) $('.sections-nav li').eq(i).children('a').addClass('active');
        };
        ...
        var init = function() {
            ...
            $(document).keydown(function(e) {
                ...
                switch(e.which) {
                    case 38:
                        if (index > 0) { move(index, index - 1, 'up'); };
                        break;
                    case 40: 
                    case 32:
                        if (index < $childrenCount - 1) { move(index, index + 1, 'down'); }
                        break;
                    default: return;
                }
                e.preventDefault();
            ...
            function move(index, nextIndex, direction) {
                if (!running && !$('.history-swap-box-in').length && !$('section.active').hasClass('clicked')) {
                    ...
                    $('.sections-holder section').eq(nextIndex).data('color-scheme') == 'light' ?
